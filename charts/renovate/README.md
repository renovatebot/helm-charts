...
![Version: 43.52.1](https://img.shields.io/badge/Version-43.52.1-informational?style=flat-square) ![AppVersion: 41.121.1](https://img.shields.io/badge/AppVersion-41.121.1-informational?style=flat-square)
...
| image.tag | string | `"41.121.1"` | Renovate image tag to pull |
