...
![Version: 37.255.0](https://img.shields.io/badge/Version-37.255.0-informational?style=flat-square) ![AppVersion: 37.255.0](https://img.shields.io/badge/AppVersion-37.255.0-informational?style=flat-square)
...
| image.tag | string | `"37.255.0"` | Renovate image tag to pull |
