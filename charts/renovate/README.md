...
![Version: 25.12.7](https://img.shields.io/badge/Version-25.12.7-informational?style=flat-square) ![AppVersion: 25.12.7](https://img.shields.io/badge/AppVersion-25.12.7-informational?style=flat-square)
...
| renovate.externalConfigFile | string | `"Bring your own config file, using your own mount"` |  |
| resources | object | `{}` |  |
| secrets | object | `{}` |  |
