...
![Version: 42.8.0](https://img.shields.io/badge/Version-42.8.0-informational?style=flat-square) ![AppVersion: 41.55.0](https://img.shields.io/badge/AppVersion-41.55.0-informational?style=flat-square)
...
| image.tag | string | `"41.55.0"` | Renovate image tag to pull |
