...
![Version: 46.268.0](https://img.shields.io/badge/Version-46.268.0-informational?style=flat-square) ![AppVersion: 44.55.0](https://img.shields.io/badge/AppVersion-44.55.0-informational?style=flat-square)
...
| image.tag | string | `"44.55.0"` | Renovate image tag to pull |
