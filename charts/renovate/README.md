...
![Version: 44.8.3](https://img.shields.io/badge/Version-44.8.3-informational?style=flat-square) ![AppVersion: 41.131.3](https://img.shields.io/badge/AppVersion-41.131.3-informational?style=flat-square)
...
| image.tag | string | `"41.131.3"` | Renovate image tag to pull |
