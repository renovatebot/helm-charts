...
![Version: 46.6.0](https://img.shields.io/badge/Version-46.6.0-informational?style=flat-square) ![AppVersion: 43.5.0](https://img.shields.io/badge/AppVersion-43.5.0-informational?style=flat-square)
...
| image.tag | string | `"43.5.0"` | Renovate image tag to pull |
