...
![Version: 37.293.0](https://img.shields.io/badge/Version-37.293.0-informational?style=flat-square) ![AppVersion: 37.293.0](https://img.shields.io/badge/AppVersion-37.293.0-informational?style=flat-square)
...
| image.tag | string | `"37.293.0"` | Renovate image tag to pull |
