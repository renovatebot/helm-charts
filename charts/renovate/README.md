...
![Version: 43.46.2](https://img.shields.io/badge/Version-43.46.2-informational?style=flat-square) ![AppVersion: 41.113.3](https://img.shields.io/badge/AppVersion-41.113.3-informational?style=flat-square)
...
| image.tag | string | `"41.113.3"` | Renovate image tag to pull |
