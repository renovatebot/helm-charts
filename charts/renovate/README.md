...
![Version: 46.0.8](https://img.shields.io/badge/Version-46.0.8-informational?style=flat-square) ![AppVersion: 43.0.10](https://img.shields.io/badge/AppVersion-43.0.10-informational?style=flat-square)
...
| image.tag | string | `"43.0.10"` | Renovate image tag to pull |
