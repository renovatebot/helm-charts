...
![Version: 39.255.0](https://img.shields.io/badge/Version-39.255.0-informational?style=flat-square) ![AppVersion: 39.255.0](https://img.shields.io/badge/AppVersion-39.255.0-informational?style=flat-square)
...
| image.tag | string | `"39.255.0"` | Renovate image tag to pull |
