...
![Version: 46.318.0](https://img.shields.io/badge/Version-46.318.0-informational?style=flat-square) ![AppVersion: 44.112.3](https://img.shields.io/badge/AppVersion-44.112.3-informational?style=flat-square)
...
| image.tag | string | `"44.112.3"` | Renovate image tag to pull |
