...
![Version: 43.41.0](https://img.shields.io/badge/Version-43.41.0-informational?style=flat-square) ![AppVersion: 41.107.0](https://img.shields.io/badge/AppVersion-41.107.0-informational?style=flat-square)
...
| image.tag | string | `"41.107.0"` | Renovate image tag to pull |
