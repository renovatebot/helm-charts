...
![Version: 44.4.0](https://img.shields.io/badge/Version-44.4.0-informational?style=flat-square) ![AppVersion: 41.127.1](https://img.shields.io/badge/AppVersion-41.127.1-informational?style=flat-square)
...
| image.tag | string | `"41.127.1"` | Renovate image tag to pull |
